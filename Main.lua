...
local old = playerGui:FindFirstChild("WatchEGGFallback")
if old then
    old:Destroy()
end

local gui = Instance.new("ScreenGui")
gui.Name = "WatchEGGFallback"
...
local featureBanner = makeLabel("FeatureBanner", "Full feature UI: loading below...", 28, 11)
featureBanner.LayoutOrder = 0
featureBanner.TextColor3 = Color3.fromRGB(167, 200, 244)

local featureList = {
    "Auto Steal Eggs", "Auto Hatch & Plant", "Egg Tracker ESP",
    "Base & Treadmill", "Auto Sell", "Events & Rewards",
    "Bat / Slap Aura", "Defense & Anti-Trap",
    "Movement / Fly", "Area / Plot / Player Travel",
    "Fullbright / Performance", "Configuration"
}
local featurePanel = Instance.new("ScrollingFrame")
featurePanel.Name = "FeaturePanel"
featurePanel.Size = UDim2.new(1, 0, 0, 96)
featurePanel.BackgroundColor3 = Color3.fromRGB(25, 27, 36)
featurePanel.BorderSizePixel = 0
featurePanel.ScrollBarThickness = 2
featurePanel.CanvasSize = UDim2.new(0,0,0,0)
featurePanel.AutomaticCanvasSize = Enum.AutomaticSize.Y
featurePanel.LayoutOrder = 3
featurePanel.Parent = body
local fpCorner = Instance.new("UICorner")
fpCorner.CornerRadius = UDim.new(0, 10)
fpCorner.Parent = featurePanel
local fpPad = Instance.new("UIPadding")
fpPad.PaddingTop = UDim.new(0, 6); fpPad.PaddingBottom = UDim.new(0, 6); fpPad.PaddingLeft = UDim.new(0, 8); fpPad.PaddingRight = UDim.new(0, 8)
fpPad.Parent = featurePanel
local fpLayout = Instance.new("UIListLayout")
fpLayout.Padding = UDim.new(0, 4)
fpLayout.Parent = featurePanel
for i, name in ipairs(featureList) do
    local b = Instance.new("TextButton")
    b.Name = "Feature_" .. i
    b.Size = UDim2.new(1, 0, 0, 28)
    b.BackgroundColor3 = Color3.fromRGB(34, 36, 47)
    b.BorderSizePixel = 0
    ...
    b.MouseButton1Click:Connect(function()
        ...
        b.BackgroundColor3 = on and Color3.fromRGB(55, 78, 62) or Color3.fromRGB(34, 36, 47)
    end)
end
...
-- ==============================================================================
-- FULL OXIDE WINDOW / FEATURE IMPLEMENTATION (PRESERVED)
-- ==============================================================================
